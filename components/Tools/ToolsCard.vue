<template>
  <div class="tools-item-container flex-box curved-box">
    <div class="tools-item-card vertical-flex">
      <div class="tools-item-card__image">
        <img :src="toolsItem.image.url" />
      </div>
      <div class="tools-item-card__title display-ellipsis --2">
        <h3>{{toolsItem.title}}</h3>
      </div>
      <div class="tools-item-card__detail display-ellipsis --5">
        <span>
          {{toolsItem.blurb}}
        </span>
      </div>
